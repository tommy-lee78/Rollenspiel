...
public class Krieger extends Spielfiguren{
     ...
     * @param xp
     */
    public Krieger(String geschlecht, String name, double groesse, int ausdauer, int agilitaet, int kraft, int armor, int xp) {
